...
const MicrosoftSurface = () => {
  const navigate = useNavigate();

  return (
    <>
      <Helmet>
        <title>Sell Microsoft Surface Online - Get Instant Cash for Surface Pro, Surface Laptop, Surface Book | Best Price | Laptap</title>
        <meta name="description" content="Sell your used Microsoft Surface for instant cash. Get the best resale value for Surface Pro 9, Surface Laptop 5, Surface Book 3, Surface Go. Free doorstep pickup across India. Instant payment via UPI. Trusted by 10,000+ sellers." />
        <meta name="keywords" content="sell Microsoft Surface, sell Surface Pro, sell Surface Laptop, sell Surface Book, sell Surface Go, Microsoft Surface resale value, sell used Surface Pro, Surface laptop buyback India, best price Surface Pro, sell Surface Pro 9, instant cash Microsoft Surface" />
        <link rel="canonical" href="https://www.laptap.in/models/microsoft-surface" />
        <link rel="alternate" hrefLang="en-IN" href="https://www.laptap.in/models/microsoft-surface" />
        <link rel="alternate" hrefLang="en" href="https://www.laptap.in/models/microsoft-surface" />
        <link rel="alternate" hrefLang="x-default" href="https://www.laptap.in/models/microsoft-surface" />
        <meta property="og:title" content="Sell Microsoft Surface Online | Best Price Guaranteed | Laptap" />
        <meta property="og:description" content="Get instant cash for your Microsoft Surface. Best resale value for Surface Pro, Surface Laptop, Surface Book models. Free doorstep pickup across India." />
        <meta property="og:url" content="https://www.laptap.in/models/microsoft-surface" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 3, "name": "Microsoft Surface", "item": "https://www.laptap.in/models/microsoft-surface" }
            ]
          })}
        </script>
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "Sell your used Microsoft Surface for instant cash with best market prices and free doorstep pickup across India",
            ...
            "review": [
              {
                ...
                "reviewBody": "Got ₹95,000 for my Surface Pro 9 with Type Cover. Best price in the market!"
              },
              {
                "@type": "Review",
                "reviewRating": { "@type": "Rating", "ratingValue": "5", "bestRating": "5" },
                "author": { "@type": "Person", "name": "Pooja Mehta" },
                "reviewBody": "Sold my Surface Laptop 5 in just 2 hours. Instant UPI payment. Very professional!"
              },
              {
                "@type": "Review",
                "reviewRating": { "@type": "Rating", "ratingValue": "5", "bestRating": "5" },
                "author": { "@type": "Person", "name": "Arun Nair" },
                "reviewBody": "Excellent service! They even bought my Surface with cracked screen. Fair valuation."
              }
            ]
          })}
        </script>
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "How much can I get for my Microsoft Surface?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Microsoft Surface resale prices: Surface Pro 9 (₹60,000-₹1,40,000), Surface Laptop 5 (₹50,000-₹1,20,000), Surface Book 3 (₹55,000-₹1,80,000), Surface Go (₹15,000-₹40,000). Price depends on model, specs, and condition."
                }
              },
              {
                "@type": "Question",
                "name": "Do you buy damaged Microsoft Surface devices?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Yes! We buy Microsoft Surface in any condition - cracked screen, battery issues, keyboard problems, or non-functional. Price is adjusted based on condition assessment."
                }
              }
            ]
          })}
