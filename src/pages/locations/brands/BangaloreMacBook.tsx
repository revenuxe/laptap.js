...
const BangaloreMacBook = () => {
  const navigate = useNavigate();

  return (
    <>
      <Helmet>
        <title>Sell Used MacBook in Bangalore | Best Price for MacBook Pro, Air | Instant Cash at Doorstep | Laptap</title>
        ...
        <link rel="canonical" href="https://laptap.in/bangalore/macbook" />
        
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Product",
            "name": "Sell Used MacBook in Bangalore",
            "description": "Sell your used MacBook for instant cash in Bangalore with free doorstep pickup and best market prices",
            "brand": {
              "@type": "Brand",
              "name": "Apple MacBook"
            },
...
export default BangaloreMacBook;
