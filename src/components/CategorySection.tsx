  ...
  const categories = [
    {
      ...
      features: [
        "Free doorstep pickup across Bengaluru",
        "Instant price evaluation within 2 minutes",
      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {categories.map((category, index) => (
            <Card 
              key={category.title}
              className={`group relative overflow-hidden border-2 hover:border-primary transition-all duration-300 hover:shadow-2xl hover:scale-105 bg-gradient-to-br ${category.gradient} animate-fade-in`}
        ...
        <div className="mt-16 pt-12 border-t">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div className="space-y-2">
              <p className="text-3xl md:text-4xl font-bold text-primary">₹5 Cr+</p>
            ...
            <div className="space-y-2">
              <p className="text-3xl md:text-4xl font-bold text-primary">24 Hours</p>
              <p className="text-sm text-muted-foreground">Payment Guarantee</p>
            </div>
          </div>
        </div>
      </div>
